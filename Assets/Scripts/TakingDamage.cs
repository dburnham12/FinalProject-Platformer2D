...
public class TakingDamage : MonoBehaviour
{
    ...
    IEnumerator KnockbackCoroutine(Vector3 direction, Rigidbody2D playerRb, PlayerController playerControls)
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Player"))
        {
            ...
            StartCoroutine(KnockbackCoroutine(direction, collision.gameObject.GetComponent<Rigidbody2D>(), collision.gameObject.GetComponent<PlayerController>()));
